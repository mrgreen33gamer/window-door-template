...
const slug     = 'heat-pump-vs-traditional-hvac-texas';
...
export const metadata: Metadata = {
  ...
  keywords: ['heat pump vs ac texas', 'heat pump waco tx', 'hvac installation central texas', 'best hvac for texas'],
...
const articleSchema = {
  ...
  keywords: 'heat pump vs ac texas, heat pump waco tx',
