...
const slug     = 'signs-ac-needs-replacement-waco-tx';
...
export const metadata: Metadata = {
  ...
  keywords: ['ac replacement waco tx', 'signs ac needs replacing', 'waco air conditioner repair vs replace', 'hvac waco', 'ac repair waco'],
...
const articleSchema = {
  ...
  keywords: 'ac replacement waco tx, signs ac needs replacing, hvac waco',
  articleSection: 'AC',
  inLanguage: 'en-US',
};
