// src/app/services/ac-repair/temple-tx/page.tsx
    ...
    <main className={styles.pageWrapper}>
      ...
      <div className={styles.section}>
        <GuaranteeSection
          ...
          ctaText="Schedule AC Repair in Temple"
          ctaLink="/contact"
        />
      </div>
      ...
      <div className={styles.section}>
        <ValueComparison rows={comparisonRows} title="" />
      </div>
      ...
      <CTABanner
        headline="AC Out in Temple? We Are Ready."
