// src/app/services/ac-repair/waco-tx/page.tsx
// Arctic Air HVAC — AC Repair in Waco, TX
"use client";
...
export default function WacoACRepairPage() {
  ...
  const faq = [
    { question: "How much does AC repair cost in Waco?", answer: "Most repairs in Waco run $150 to $650. Capacitor replacement runs $150 to $250. Refrigerant recharges run $250 to $500. We always provide a flat-rate quote before starting." },
    { question: "Can you fix my AC the same day I call in Waco?", answer: "In most cases yes, especially during business hours. Call before noon and same-day service is usually available for Waco and surrounding McLennan County." },
    { question: "Do you offer emergency AC service in Waco?", answer: "Yes, 7 days a week including evenings. In Central Texas heat, a broken AC is a real emergency. Call us anytime at (254) 900-1234." },
    { question: "What AC brands do you service in Waco?", answer: "All major brands including Carrier, Trane, Lennox, Rheem, Goodman, York, and Daikin. Any make or model in Waco or anywhere in McLennan County." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        ...
        subtitle="Same-day AC diagnosis, flat-rate pricing, and a 1-year parts and labor warranty — serving Waco and McLennan County."
      />

      <TrustBar headline="Trusted by Waco homeowners for fast, fair AC repair since 2010" />
      ...
      <div className={styles.section}>
        <GuaranteeSection
          ...
          ctaText="Schedule AC Repair in Waco"
          ctaLink="/contact"
        />
      </div>

      <div className={styles.section}>
        <LocalServiceAreas cityName="Waco" areas={localAreas} servicePath="services/ac-repair/waco-tx" title="AC Repair Across Central Texas" />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Waco" faq={faq} title="AC Repair FAQs — Waco" />
      </div>

      <CTABanner
        headline="AC Out in Waco? We Are Ready."
      ...
      <div className={styles.section}>
        <Variant2
          title="Schedule AC Repair in Waco"
          cityName="Waco"
          slug="services/ac-repair/waco-tx"
          spot="ac-repair-waco-tx-page"
          formVariant={2}
        />
      </div>
