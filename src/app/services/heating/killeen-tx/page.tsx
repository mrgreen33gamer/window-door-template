// Arctic Air HVAC — Heating Repair in Killeen, TX
"use client";
...
export default function KilleenHeatingRepairPage() {
  ...
  const faq = [
    { question: "How much does furnace repair cost in Killeen?", answer: "Furnace repairs in Killeen typically run $150 to $600. Ignitor replacement runs $150 to $250. Gas valve repair is $250 to $400. We provide a flat-rate quote before any work starts." },
    { question: "Do you offer same-day heating service in Killeen?", answer: "Yes, same-day and emergency heating service is available for Killeen. Call us at (254) 900-1234 and we will get someone out fast." },
    { question: "My heater turns on but blows cold air in Killeen — what is wrong?", answer: "Common causes include a bad ignitor, failed flame sensor, tripped limit switch, or a gas supply issue. Our tech will diagnose and quote it on the first visit." },
    { question: "Do you service heat pumps in Killeen?", answer: "Yes, heat pump repair is fully within our scope. We service all brands and configurations including dual-fuel heat pump systems in Killeen and throughout Bell County." },
    { question: "Do you check for carbon monoxide during heating calls in Killeen?", answer: "Yes, we perform a CO safety test and heat exchanger inspection on every single heating service call. It is standard, not an add-on." },
  ];
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title="Heating Repair in Killeen, TX"
        subtitle="Furnace repair, heat pump service, and emergency heating calls — same-day available in Killeen and throughout Bell County."
      />

      <TrustBar headline="Trusted by Killeen homeowners for reliable heating service since 2010" />
      ...
      <div className={styles.section}>
        <LocalServiceAreas cityName="Killeen" areas={localAreas} servicePath="services/heating/killeen-tx" title="Heating Repair Across Central Texas" />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Killeen" faq={faq} title="Heating Repair FAQs — Killeen" />
      </div>

      <CTABanner
        headline="No Heat in Killeen? We Come to You Same Day."
      ...
      <div className={styles.section}>
        <Variant2
          title="Schedule Heating Service in Killeen"
          cityName="Killeen"
          slug="services/heating/killeen-tx"
          spot="heating-killeen-tx-page"
          formVariant={2}
        />
      </div>
