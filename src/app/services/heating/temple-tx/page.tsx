// Arctic Air HVAC — Heating Repair in Temple, TX
"use client";
...
export default function TempleHeatingRepairPage() {
  ...
  const faq = [
    { question: "How much does furnace repair cost in Temple?", answer: "Furnace repairs in Temple typically run $150 to $600. Ignitor replacement runs $150 to $250. Gas valve repair is $250 to $400. We provide a flat-rate quote before any work starts." },
    { question: "Do you offer same-day heating service in Temple?", answer: "Yes, same-day and emergency heating service is available for Temple. Call us at (254) 900-1234 and we will get someone out fast." },
    { question: "My heater turns on but blows cold air in Temple — what is wrong?", answer: "Common causes include a bad ignitor, failed flame sensor, tripped limit switch, or a gas supply issue. Our tech will diagnose and quote it on the first visit." },
    { question: "Do you service heat pumps in Temple?", answer: "Yes, heat pump repair is fully within our scope. We service all brands and configurations including dual-fuel heat pump systems in Temple and throughout Bell County." },
    { question: "Do you check for carbon monoxide during heating calls in Temple?", answer: "Yes, we perform a CO safety test and heat exchanger inspection on every single heating service call. It is standard, not an add-on." },
  ];
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title="Heating Repair in Temple, TX"
        subtitle="Furnace repair, heat pump service, and emergency heating calls — same-day available in Temple and throughout Bell County."
      />

      <TrustBar headline="Trusted by Temple homeowners for reliable heating service since 2010" />
      ...
      <div className={styles.section}>
        <LocalServiceAreas cityName="Temple" areas={localAreas} servicePath="services/heating/temple-tx" title="Heating Repair Across Central Texas" />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Temple" faq={faq} title="Heating Repair FAQs — Temple" />
      </div>

      <CTABanner
        headline="No Heat in Temple? We Come to You Same Day."
      ...
      <div className={styles.section}>
        <Variant2
          title="Schedule Heating Service in Temple"
          cityName="Temple"
          slug="services/heating/temple-tx"
          spot="heating-temple-tx-page"
          formVariant={2}
        />
      </div>
