...
const DEFAULT_ROWS: ComparisonRow[] = [
  ...
  { feature: '10-Year Installation Warranty',            us: true,  others: false },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'ClearView vs. The Other Guys' }: ValueComparisonProps) {
  return (
