        ...
        <div className={styles.storyBody}>
          <div className={styles.storyPull}>
            <p className={styles.pullQuote}>
              "We started ClearView because we were tired of watching homeowners get ripped off by fly-by-night window and door companys."
            </p>
            <div className={styles.pullAttrib}>
              <span className={styles.pullName}>— Daniel Crowe</span>
              <span className={styles.pullTitle}>Founder, ClearView Windows & Doors</span>
            </div>
          </div>

          <div className={styles.storyText}>
            <p className={styles.storyParagraph}>
              Founded in 2012 in Waco, TX, ClearView Windows & Doors started with one truck and one principle:
              give homeowners the straight story about their windows and doors, charge a fair price, and back the
            ...
            <div className={styles.milestones}>
              {[
                ...
                { year: '2024', label: '3,500+ installs completed' },
              ].map((m, i) => (
