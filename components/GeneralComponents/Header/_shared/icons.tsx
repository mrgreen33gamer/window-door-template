// _archetype-library/shared/icons.tsx
// Small inline-SVG icon primitives shared across archetype components.
// Kept dependency-free (no icon package) to match the existing convention
// in components/GeneralComponents/Header and components/Pages/Home/WelcomePage.
